...
Ooh, so it seems that French don't have Britons so much! The number of signatures from Gibraltar is also very interesting, considering that the population of the territory is just about [35,000](https://en.wikipedia.org/wiki/Gibraltar).
...
electoralData = read.csv(
  text = getURL("https://dl.dropboxusercontent.com/u/4954206/r/UkConstituencyData2015.csv"),
  header = TRUE,
...
This notebook is licensed with a [CC-BY 4.0](https://creativecommons.org/licenses/by/4.0/) license. Please attribute by linking back to this file.
